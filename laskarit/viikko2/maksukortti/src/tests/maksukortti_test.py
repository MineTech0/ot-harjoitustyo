...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivise_summan_lataaminen_ei_muuta_kortin_saldoa(self):
        self.kortti.lataa_rahaa(-100)
        
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10.00 euroa")
        
    def test_kortilta_pystyy_ostamaan_edeullisen_lounaan_jos_rahaa_on_vain_lounaan_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        
        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")
        
    def test_kortilta_pystyy_ostamaan_maukkaan_lounaan_jos_rahaa_on_vain_lounaan_verran(self):
