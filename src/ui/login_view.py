...
class LoginView(BaseView):
    ...
    def _initialize(self):
        username_label = ttk.Label(master=self._frame, text="Syötä käyttäjänimi:")
        ...
        register_button = ttk.Button(master=self._frame, text="Rekisteröidy", command=lambda: self.navigate('register'))
